import { DailyMeetingWaitingProvider } from "../../src/providers/daily-meeting/daily-meeting-waiting";

describe('DailyMeetingWaitingProvider', () => {

  let provider: DailyMeetingWaitingProvider;

  beforeEach(() => {
    provider = new DailyMeetingWaitingProvider();
  });

  it('DailyMeetingWaitingProvider initialized', () => {
