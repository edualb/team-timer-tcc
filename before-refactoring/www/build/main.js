...
var GroupPage = /** @class */ (function () {
    ...
    GroupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-group',template:/*ion-inline-start:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/group/group.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n        {{ grupo?.titulo }}\n    </ion-title>\n    <ion-buttons end>\n        <button ion-button icon-only (click)="vaiParaSettingsGroup()">\n            <ion-icon class="ion-md-settings ion-ios-settings"></ion-icon>\n        </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding class="background-default">\n    <ion-row>\n        <ion-col>\n            <button ion-button full icon-start large="true" \n                (click)="vaiParaTimer()" [disabled]="grupo?.membros.length === 0 || faltouTodosMembros">\n                <ion-icon class="icon ion-md-timer ion-ios-timer"></ion-icon>\n                START TIMER\n            </button>\n        </ion-col>\n    </ion-row>\n    <ion-list *ngIf="grupo">\n        <ion-item color="background-default" class="texto"\n            *ngFor="let membro of grupo.membros">\n                <ion-label>{{ membro?.nome }}</ion-label>\n                <ion-checkbox [(ngModel)]="membro.presenca" (click)="possuiPresencaMembros(grupo)"></ion-checkbox>\n                <button item-end ion-button icon-only clear="true" (click)="deletaMembro(membro)">\n                    <ion-icon class="icon ion-md-trash ion-ios-trash"></ion-icon>\n                </button>\n        </ion-item>\n        <br/>\n        <ion-item color="background-default" class="texto">\n            <page-button-add-member [id]="grupo.membros.length + 1" [tempo]="grupo.tempoLimite" (respostaMembros)="addMembro($event)"></page-button-add-member>\n        </ion-item>\n    </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/group/group.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__providers_grupo_grupo__["a" /* GrupoProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_grupo_grupo__["a" /* GrupoProvider */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__providers_grupo_membro__["a" /* MembroProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__providers_grupo_membro__["a" /* MembroProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__ionic_native_insomnia__["a" /* Insomnia */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ionic_native_insomnia__["a" /* Insomnia */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* Platform */]) === "function" && _f || Object])
    ], GroupPage);
    return GroupPage;
...
var TimerGroupPage = /** @class */ (function () {
    ...
    function TimerGroupPage(navCtrl, navParams, grupoProvider, membroProvider, insomnia, platform) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.grupoProvider = grupoProvider;
        this.membroProvider = membroProvider;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/app/app.html"*/'<div *ngIf="showSplash" class="splash">\n    <div class="sk-folding-cube">\n        <div class="sk-cube1 sk-cube"></div>\n        <div class="sk-cube2 sk-cube"></div>\n        <div class="sk-cube4 sk-cube"></div>\n        <div class="sk-cube3 sk-cube"></div>\n    </div>\n</div>\n<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/app/app.html"*/
        }),
...
var TimerPerMemberPage = /** @class */ (function () {
    ...
    TimerPerMemberPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-timer-per-member',template:/*ion-inline-start:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/timer-per-member/timer-per-member.html"*/'<div *ngIf="show" >\n  <ion-grid *ngFor="let membro of membros">\n    <ion-row>\n        <ion-col>\n            <h6 ion-text color="primary">\n                {{ membro.nome }} ({{ membro.tempo }})\n            </h6>\n        </ion-col>\n    </ion-row>\n  </ion-grid>\n</div>\n'/*ion-inline-end:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/timer-per-member/timer-per-member.html"*/,
        }),
...
var ButtonAddMemberPage = /** @class */ (function () {
    ...
    ButtonAddMemberPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-button-add-member',template:/*ion-inline-start:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/button-add-member/button-add-member.html"*/'<button item-start ion-button block outline icon-only large="true" (click)="openAddMembro()">\n    <ion-icon item-start class="icon ion-md-person-add ion-ios-person-add"></ion-icon>\n    Add member\n</button>\n'/*ion-inline-end:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/button-add-member/button-add-member.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */],
...
var ButtonSharedPage = /** @class */ (function () {
    ...
    ButtonSharedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-button-shared',template:/*ion-inline-start:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/button-shared/button-shared.html"*/'<button ion-button icon-start full color="secondary" large="true" (click)="share()">\n        <ion-icon class="icon ion-md-share ion-ios-share"></ion-icon>\n        Share Time\n</button>\n'/*ion-inline-end:"/home/eduardo/Documentos/Projects/team-timer-tcc/before-refactoring/src/pages/button-shared/button-shared.html"*/,
        }),
